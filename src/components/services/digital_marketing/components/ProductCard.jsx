...
function ProductCard({ imgURL, name, price }) {
  return (
    <div className="relative flex flex-col w-fit justify-center group">
      <img
        src={imgURL}
        className="w-[18rem] max-tablet:w-[15rem] flex items-center justify-center mr-4 group-hover:opacity-50 transition-opacity duration-300 ease-in-out rounded-xl"
        alt={name}
      />
