...
const Domains = () => {
  ...
  const tthree = list[0].items.slice(6, 9);

  return (
    <div className="flex max-tablet:flex-col w-full max-tablet:h-full h-[45rem]">
      ...
      <div className="w-[50%] max-tablet:w-full max-mobile:py-10 max-tablet:py-20 flex flex-col items-center justify-center">
        {list.map((i) => (
