  ...
  return (
    ...
    <section className='px-16 max-mobile:px-8 py-10 flex flex-col gap-4 w-full'>
      <div className='flex flex-col gap-2'>
        <h2 className='capitalize text-4xl max-tablet:text-2xl max-mobile:text-lg lg:max-w-lg font-bold'>Our <span className='text-t-primary max-tablet:text-2xl max-mobile:text-lg'>Popular </span>Products</h2>
