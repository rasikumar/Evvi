        ...
        <div className="flex w-[90%] gap-5 m-auto h-full max-tablet:flex-col max-tablet:gap-0">
            ...
            <div className="w-[50%] p-2 flex flex-col gap-10 mt-24 max-mobile:mt-20 max-tablet:w-full">
                ...
                <div className="flex gap-10 max-mobile:gap-2">
                    <p className="btn-primary desktop:text-2xl max-mobile:text-sm flex items-center max-mobile:w-[10rem] gap-3">
                        {HeroText[2].content}
                        <FaArrowUpRightFromSquare />
                    </p>
                    <p className="btn-secondary desktop:text-2xl max-mobile:text-sm flex items-center max-mobile:w-[10rem] gap-1">
                        <FaSquarePhone />
                        {HeroText[3].content}
                    </p>
                </div>
